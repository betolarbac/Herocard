...
function loadCharactersCarousel(offset) {
  listCharacters(offset, characters => {
    characterCarousel = createCarousel('Outros Personagem', filterCharacterWithoutImages(characters), 'default', loadMoreItems);
...
function loadTopCharactersCarousel() {
  listTopCharacters(characters => createCarousel('Top Personagem', characters, 'big'));
}
